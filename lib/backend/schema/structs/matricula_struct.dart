...
class MatriculaStruct extends BaseStruct {
  MatriculaStruct({int? id, int? alumno, int? asignatura, double? nota})
    : _id = id,
      _alumno = alumno,
  ...
  Map<String, dynamic> toSerializableMap() => {
    ...
    'alumno': serializeParam(_alumno, ParamType.int),
    'asignatura': serializeParam(_asignatura, ParamType.int),
    'nota': serializeParam(_nota, ParamType.double),
  }.withoutNulls;

  static MatriculaStruct fromSerializableMap(Map<String, dynamic> data) =>
      MatriculaStruct(
        id: deserializeParam(data['id'], ParamType.int, false),
        alumno: deserializeParam(data['alumno'], ParamType.int, false),
        asignatura: deserializeParam(data['asignatura'], ParamType.int, false),
        nota: deserializeParam(data['nota'], ParamType.double, false),
      );
...
MatriculaStruct createMatriculaStruct({
  ...
  double? nota,
    ...
    MatriculaStruct(id: id, alumno: alumno, asignatura: asignatura, nota: nota);
