...
class ProfesorStruct extends BaseStruct {
  ProfesorStruct({int? id, int? departamento})
    : _id = id,
  ...
  Map<String, dynamic> toMap() =>
      {'id': _id, 'departamento': _departamento}.withoutNulls;

  @override
  Map<String, dynamic> toSerializableMap() => {
    'id': serializeParam(_id, ParamType.int),
    'departamento': serializeParam(_departamento, ParamType.int),
  }.withoutNulls;
...
ProfesorStruct createProfesorStruct({int? id, int? departamento}) =>
    ProfesorStruct(id: id, departamento: departamento);
