...
class AsignaturaStruct extends BaseStruct {
  ...
  Map<String, dynamic> toSerializableMap() => {
    ...
    'creditos': serializeParam(_creditos, ParamType.int),
    'ano': serializeParam(_ano, ParamType.int),
    'carrera': serializeParam(_carrera, ParamType.int),
    'profesor': serializeParam(_profesor, ParamType.int),
  }.withoutNulls;
  ...
  static AsignaturaStruct fromSerializableMap(Map<String, dynamic> data) =>
      AsignaturaStruct(
        ...
        creditos: deserializeParam(data['creditos'], ParamType.int, false),
        ano: deserializeParam(data['ano'], ParamType.int, false),
        carrera: deserializeParam(data['carrera'], ParamType.int, false),
        profesor: deserializeParam(data['profesor'], ParamType.int, false),
      );
