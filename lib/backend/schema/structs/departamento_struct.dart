...
class DepartamentoStruct extends BaseStruct {
  DepartamentoStruct({int? id, String? name, String? descripcion})
    : _id = id,
      _name = name,
  ...
  Map<String, dynamic> toMap() =>
      {'id': _id, 'name': _name, 'descripcion': _descripcion}.withoutNulls;
...
DepartamentoStruct createDepartamentoStruct({
  ...
  String? name,
  String? descripcion,
}) => DepartamentoStruct(id: id, name: name, descripcion: descripcion);
